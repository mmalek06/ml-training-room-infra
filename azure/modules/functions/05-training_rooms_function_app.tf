data "azurerm_storage_account_blob_container_sas" "storage_account_blob_container_sas_for_training_rooms" {
...
resource "azurerm_linux_function_app" "mltr_code_training_rooms_function_app" {
  name                       = "mltr-code-training-rooms-function-app"
