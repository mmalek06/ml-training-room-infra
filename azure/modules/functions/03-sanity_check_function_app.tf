data "azurerm_storage_account_blob_container_sas" "storage_account_blob_container_sas_for_sanity_check" {
...
resource "azurerm_linux_function_app" "mltr_code_sanity_check_function_app" {
  name                       = "mltr-code-sanity-check-function-app"
