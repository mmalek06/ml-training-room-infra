...
$ServicePrincipalName = "$AppNamePrefix-principal-$SubscriptionEnv-notf"
...
$KeyVaultName = "mtr-kv-$SubscriptionEnv-notf1"
$TerraformFileContents = Get-Content "../001-resource_group.tf" -Raw
